...
hex_to_str:
	...
	li $t0, '\n'
	sb $t0, 8($a1)
	li $t0, 8        #contains the offset of the byte
	li $t3, 10
hex_to_str_loop:
	addiu $t0, $t0, -1
	add $t1, $t0, $a1   #t1 contains byte address of next char
	andi $t2, $a0, 15   #take lower 4 bits
	srl $a0, $a0, 4     #shift int right to prepare to read next byte
	blt $t2, $t3, zero_to_nine
	addiu $t2, $t2, 87   #'a' - 10
	j store_hex_char 
zero_to_nine:
	addiu $t2, $t2, 48
